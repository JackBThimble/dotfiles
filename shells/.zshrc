...
# Source completion, syntax-highlighting, and fzf scripts
...
export PATH=/home/jasperdaniels/.local/bin:$PATH
export PATH=/home/jasperdaniels/.fnm:$PATH
eval "`fnm env`"
...
alias ls="exa -al --group-directories-first --color=always --icons"
alias la="exa -a --group-directories-first --color=always --icons"
alias ll="exa -l --group-directories-first --color=always --icons"
